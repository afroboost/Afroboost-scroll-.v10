...
// v13.4: Composants extraits pour alléger CoachDashboard
import { CreditsGate, CreditBoutique, StripeConnectTab, CoursesManager, OffersManager, ConceptEditor } from "./dashboard";
